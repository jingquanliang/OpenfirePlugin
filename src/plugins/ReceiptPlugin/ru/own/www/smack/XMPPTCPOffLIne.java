...
//                    new DeliveryReceiptRequest.Provider());
        ...
        setStatus();  //设置状态
        sendMessage("admina@jql-pc", "i am from java"); //发送消息
        ReceiveMessage(); //接受消息
...
//        要求回执的代码，已经抽取为了函数
        ...
        ss.autoAddDeliveryReceiptRequests();
...
//                if (ack == null) {
//                    System.out.println("Received message stanza with receipt request from '" + from
